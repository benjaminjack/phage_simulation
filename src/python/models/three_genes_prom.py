...
def execute(output):
    ...
    plasmid.add_gene(name="proteinX", start=26, stop=225,
                     rbs_start=(26 - 15), rbs_stop=26, rbs_strength=1e7)
    plasmid.add_gene(name="proteinY", start=241, stop=280,
                     rbs_start=(241 - 15), rbs_stop=241, rbs_strength=1e7)
    plasmid.add_promoter(name="p1", start=281, stop=290,
                         interactions={"rnapol": 2e8})
    plasmid.add_gene(name="proteinZ", start=306, stop=595,
