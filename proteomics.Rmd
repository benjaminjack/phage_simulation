...
class3_plot_data <- filter(all_data, 
                           tabasco_id %in% c('gp3','gp10A','gp11','gp12','gp13','gp14','gp15', 'gp18'))
...
class3_plot_ms <- class3_plot %+% filter(class3_plot_data, time == "9min") + 
  facet_wrap(~tabasco_id, scales = "free_y", ncol = 2, dir = "v")

save_plot("figures/class3.pdf", class3_plot_ms, base_height = 8, base_width = 6)
