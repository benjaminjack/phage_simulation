make_plot <- function(file) {
  ...
  plot_grid(plot1, plot2, ncol=2, rel_widths = c(1, 1.5), align = "h")
}
...
make_plot2 <- function(file) {
  ...
  plot_grid(plot1, plot2, plot3, ncol=3, rel_widths = c(1, 1, 1.3), align = "h")
}

three_genes_no_deg <- make_plot("three_genes_no_deg_counts.tsv")
save_plot("three_genes_no_deg.pdf", three_genes_no_deg, ncol = 2, base_width = 4)

three_genes_w_deg <- make_plot("three_genes_w_deg_counts.tsv")
save_plot("three_genes_w_deg.pdf", three_genes_w_deg, ncol = 2, base_width = 4)

three_genes_prom <- make_plot("three_genes_prom_counts.tsv")
save_plot("three_genes_prom.pdf", three_genes_prom, ncol = 2, base_width = 4)

three_genes_prom_deg <- make_plot("three_genes_prom_deg_counts.tsv")
save_plot("three_genes_prom_deg.pdf", three_genes_prom_deg, ncol = 2, base_width = 4)

three_genes_rnase_site <- make_plot("three_genes_rnase_site_counts.tsv")
save_plot("three_genes_rnase_site.pdf", three_genes_rnase_site, ncol = 2, base_width = 4)

three_genes_rnase_prom <- make_plot2("three_genes_rnase_prom_counts.tsv")
