...
sim_data2 <- load_sim_data("../data/simulated/run_050217_wt_counts.tsv") 
...
cor_plot <- ggplot(sim_data3, aes(x = time, y = cor, color = -log(pval))) + geom_line() + ylim(0,1) + geom_vline(xintercept = 1200)
